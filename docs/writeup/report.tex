...
We implemented several versions of the NIW sampler. We tested its runtime by varying $n$, the number of samples. We did not test varying $d$, the dimensionality of the output.
